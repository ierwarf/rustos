...
pub(crate) fn apply_kernel_cargo_env<'a>(
    ...
    command
        ...
        .env(
            "RUSTOS_SCHEDULER_PHASE_PROFILE",
            config.project.scheduler_telemetry.phase_profile.to_string(),
        )
        .env(
            "RUSTOS_SYSCALL_PHASE_PROFILE",
        ...
        .env(
            "RUSTOS_USERMEM_PHASE_PROFILE",
            config.project.usermem_telemetry.phase_profile.to_string(),
        )
        .env(

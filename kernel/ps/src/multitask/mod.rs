...
pub use self::current::{
    ...
    mark_user_process_exiting, note_process_exit_status,
    ...
    set_next_spawn_pick_hint, terminate_user_task, user_log_ids_for_task, wait_for_child,
    wake_task, wake_user_task, with_current_mm, with_current_process_credentials,

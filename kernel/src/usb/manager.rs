...
const HID_DRIVER_NAME: &str = "hid";
const HID_DRIVER_MODULE_PATH: &str = "system/drivers/input/hid.ko";
const HID_DRIVER_PRIORITY: i32 = 100;

const HID_GENERIC_DRIVER_NAME: &str = "hid-generic";
const HID_GENERIC_DRIVER_MODULE_PATH: &str = "system/drivers/input/hid-generic.ko";
const HID_GENERIC_DRIVER_PRIORITY: i32 = 110;

const USBHID_DRIVER_NAME: &str = "usbhid";
const USBHID_DRIVER_MODULE_PATH: &str = "system/drivers/input/usbhid.ko";
const USBHID_DRIVER_PRIORITY: i32 = 120;
...
pub(crate) fn init() {
    ...
    if found_xhci {
        ...
        crate::debug::println!("usb: xHCI present, loading USB input modules");
        crate::driver::initialize_loadable_modules_for_bus(DriverBus::Usb);
        USB_STATE.lock().stage = UsbSubsystemStage::ModulesLoaded;
    } else {
...
fn register_usb_input_modules() {
    crate::driver::register_loadable_elf_with_priority(
        HID_DRIVER_NAME,
        DriverClass::Input,
        DriverBus::Usb,
        HID_DRIVER_PRIORITY,
        HID_DRIVER_MODULE_PATH,
    );
    crate::driver::register_loadable_elf_with_priority(
        HID_GENERIC_DRIVER_NAME,
        DriverClass::Input,
        DriverBus::Usb,
        HID_GENERIC_DRIVER_PRIORITY,
        HID_GENERIC_DRIVER_MODULE_PATH,
    );
    crate::driver::register_loadable_elf_with_priority(
        USBHID_DRIVER_NAME,
        DriverClass::Input,
        DriverBus::Usb,
        USBHID_DRIVER_PRIORITY,
        USBHID_DRIVER_MODULE_PATH,
    );
}

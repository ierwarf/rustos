...
const FILE_MMAP_COPY_CHUNK_LEN: usize = 64 * 1024;
...
pub(crate) const fn linux_signal_bit(signal: u64) -> Option<u64> {
...
pub(super) const fn linux_unblockable_signal_mask() -> u64 {
    (1_u64 << (linux_abi::SIGKILL - 1)) | (1_u64 << (linux_abi::SIGSTOP - 1))
}

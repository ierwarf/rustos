...
pub(super) fn dispatch_linux_syscall(frame: &mut SyscallFrame) -> u64 {
    ...
    let result = match frame.rax {
        ...
        linux_abi::SYS_SENDTO => syscall_linux_sendto(
        ...
        linux_abi::SYS_EPOLL_WAIT => {
            syscall_linux_epoll_wait(frame.rdi, frame.rsi, frame.rdx, (frame.r10 as u32) as i32)
        }
        ...
        linux_abi::SYS_MOUNT => {
            syscall_linux_mount(frame.rdi, frame.rsi, frame.rdx, frame.r10, frame.r8)
        }
        linux_abi::SYS_GETCWD => syscall_linux_getcwd(frame.rdi, frame.rsi),
        linux_abi::SYS_MKDIR => syscall_linux_mkdir(frame.rdi, frame.rsi),
        linux_abi::SYS_CHDIR => syscall_linux_chdir(frame.rdi),
        ...
        linux_abi::SYS_GETSOCKNAME => syscall_linux_getsockname(frame.rdi, frame.rsi, frame.rdx),
        linux_abi::SYS_GETPEERNAME => syscall_linux_getpeername(frame.rdi, frame.rsi, frame.rdx),
        linux_abi::SYS_SETSOCKOPT => {
            syscall_linux_setsockopt(frame.rdi, frame.rsi, frame.rdx, frame.r10, frame.r8)
        }
        linux_abi::SYS_GETSOCKOPT => {
            syscall_linux_getsockopt(frame.rdi, frame.rsi, frame.rdx, frame.r10, frame.r8)
        }
        linux_abi::SYS_SHUTDOWN => syscall_linux_shutdown(frame.rdi, frame.rsi),
        ...
        linux_abi::SYS_UMOUNT2 => syscall_linux_umount2(frame.rdi, frame.rsi),
...
fn syscall_linux_getsockname(fd: u64, addr_ptr: u64, addr_len_ptr: u64) -> u64 {
...
fn syscall_linux_getpeername(fd: u64, addr_ptr: u64, addr_len_ptr: u64) -> u64 {
...
fn syscall_linux_shutdown(fd: u64, how: u64) -> u64 {
...
fn syscall_linux_epoll_create1(flags: u64) -> u64 {
...
fn syscall_linux_epoll_ctl(epfd: u64, op: u64, fd: u64, event_ptr: u64) -> u64 {
...
fn syscall_linux_chdir(path_ptr: u64) -> u64 {
...
fn syscall_linux_mkdir(path_ptr: u64, mode: u64) -> u64 {
...
fn syscall_linux_getdents64(fd: u64, user_ptr: u64, user_len: u64) -> u64 {
...
fn syscall_linux_execve(frame: &mut SyscallFrame) -> u64 {
...
fn syscall_linux_execveat(frame: &mut SyscallFrame) -> u64 {
...
fn syscall_linux_umount2(target_ptr: u64, flags: u64) -> u64 {
...
fn syscall_linux_get_robust_list(pid: u64, head_ptr_ptr: u64, len_ptr: u64) -> u64 {

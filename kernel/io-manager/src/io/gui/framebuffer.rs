...
// uiserver owns framebuffer damage policy and presentation scheduling. Ring0
// keeps mapped framebuffer memory, bounded copy/dirty tracking, and
// boot/display transition backing store.

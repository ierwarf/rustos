// RING3-MIGRATION-REFERENCE START: compat exception: usbdrv/inputd own USB
// runtime emulation policy. Ring0 keeps Linux .ko URB/HID callback forwarding
// into the current native USB substrate.
use core::ffi::c_void;
...
// RING3-MIGRATION-REFERENCE END: usbdrv/inputd-owned USB emulation compat substrate.

...
pub(crate) struct IpcMessage {
    ...
    pub payload: Vec<u8>,
    pub attached_handles: Vec<crate::user::handles::KernelHandle>,
}
...
pub(crate) fn enqueue_message(
    ...
    header: IpcHeader,
    payload: &[u8],
    attached_handles: &[crate::user::handles::KernelHandle],
) -> Result<(), IpcError> {
...
mod tests {
    use super::{
        IpcError, IpcHeader, accept_channel, connect_named_port, connect_port, create_channel_pair,
        ...
        map_shared_region, port_name, queue_channel_for_accept, shared_region_len, signal_event,
    };
    use crate::user::handles::ConsoleStreamKind;

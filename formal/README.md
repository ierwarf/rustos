...
every AP to reject an initial non-WB PAT0, program PAT2=UC/PAT4=WC, and exactly
read back the full expected PAT MSR before `OnlineParked` or private-ready.
Display pixel memory remains a separate contract, and no network/display cache

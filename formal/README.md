...
| boot-volume-read/BootVolumeRead | vfsd boot-volume broker and io-manager block dispatch | empty, unaligned, overflowing, and out-of-range requests never dispatch; chunk accounting is exact; timeout and device revocation remain distinguishable from transport failure |

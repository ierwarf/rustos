...
| Hardening request | `commercial-quality-gates.md`, `system-flows.md`, `contracts-abi.md`, `kernel-api-map.md` | highest-risk whole flow first; exact API, broker, service, lock, memory, or device path found by MCP search |

...
use rustos_user_abi::syscall::{
    ...
    SYSCALL_OFFLOAD_OP_LINUX_GETGID, SYSCALL_OFFLOAD_OP_LINUX_GETRANDOM,
    SYSCALL_OFFLOAD_OP_LINUX_GETUID, SYSCALL_OFFLOAD_OP_LINUX_PRLIMIT64,
    SYSCALL_OFFLOAD_OP_LINUX_SCHED_GETAFFINITY, SYSCALL_OFFLOAD_OP_LINUX_SETGID,
    SYSCALL_OFFLOAD_OP_LINUX_SETUID, SYSCALL_OFFLOAD_OP_LINUX_UMASK,
...
fn validate_request(received: usize, request: &LinuxSyscallOffloadRequest) -> Result<(), i32> {
    ...
    match request.op {
        ...
        | SYSCALL_OFFLOAD_OP_LINUX_GETRANDOM => Ok(()),
        _ => Err(libc::EINVAL),
    }
}

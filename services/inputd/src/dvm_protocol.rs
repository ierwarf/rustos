use rustos_user_abi::syscall::{
    InputDvmRecordWire, InputIngressWire, InputKeyboardEventWire, InputPointerPacketWire,
    InputPointerPositionWire, INPUTD_ACCESS_NATIVE, INPUTD_DVM_RECORD_BYTES,
    INPUTD_DVM_RECORD_FLAG_RESET, INPUTD_INGRESS_FLAG_DVM_SOURCE,
